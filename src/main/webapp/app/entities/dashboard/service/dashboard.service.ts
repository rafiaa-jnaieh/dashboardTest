...
export class DashboardService {
  ...
  update(dashboard: IDashboard): Observable<EntityResponseType> {
    return this.http.put<IDashboard>(`${this.resourceUrl}/${getDashboardIdentifier(dashboard) as string}`, dashboard, {
      observe: 'response',
    });
  }

  partialUpdate(dashboard: IDashboard): Observable<EntityResponseType> {
    return this.http.patch<IDashboard>(`${this.resourceUrl}/${getDashboardIdentifier(dashboard) as string}`, dashboard, {
      observe: 'response',
    });
  }
